...
description: Dooray 업무의 제목·상태·내용·태그·첨부·댓글 이력을 조회한다. 사용법 /dooray-read-full <업무번호> [개수]. 업무의 전체 맥락이나 댓글 이력까지 필요할 때 사용.
...
첨부파일 다운로드를 원하면 `dooray download <업무번호> [파일명|번호|all]`을 실행한다.
